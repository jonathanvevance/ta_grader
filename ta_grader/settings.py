"""
Django settings for ta_grader project.
...
SECRET_KEY = 'django-insecure-c2n22w_2aw2&6*jka=bk(b9+nr5_q38jd$dfozt2jljt^gq2gr'
...
WSGI_APPLICATION = 'ta_grader.wsgi.application'
